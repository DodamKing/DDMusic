...
<head>
    ...
    <link rel="stylesheet" href="${ctp }/resources/css/signup.css">
</head>
<body>
...
<jsp:include page="/WEB-INF/views/include/findModal.jsp" />
            ...
            <div class="container p-3 my-3 border">
                <div class="form-container">
                    ...
                    <div class="d-flex form-foot">
                        <div class="p-2 mr-auto"><a href="${ctp }/user/login">로그인</a></div>
	...
	<script src="${ctp }/resources/js/signup.js?v=2"></script>
</body>
</html>