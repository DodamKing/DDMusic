	...
	<div class="card-body nav-w">
	    <div>
	        ...
	        <div class="list-group my-group">
	            <ul>
                	<c:if test="${sVO != null }">
		                <li class="list-group-item list-group-item-light"><a href="${ctp }/user/membership" target="_blank">My 멤버십</a></li>
		                <li class="list-group-item list-group-item-light"><a href="">공지사항</a></li>
		                <li class="list-group-item list-group-item-light"><a href="${ctp }/user/profile" target="_blank">계정설정</a></li>
